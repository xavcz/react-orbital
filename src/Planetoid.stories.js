...
storiesOf('Planetoid', module)
  .add('default', () => <IconWrapper><Planetoid diameter={62} /></IconWrapper>)
  .add('with moons', () => (
    <IconWrapper>
      <Planetoid top={75} left={15} diameter={8} />
      <Planetoid top={10} left={95} diameter={12} />
      <Planetoid diameter={62} />
    </IconWrapper>
  ))
  ...
  .add('with animated moons and lines', () => (
    <IconWrapper>
      <Planetoid diameter={8} animation="moonTop" />
      <Planetoid diameter={12} animation="moonBottom" />
      <Planetoid diameter={62}>
        <Line top={15} left={0} length={60} />
        <Line top={30} left={0} length={20} />
        <Line top={30} left={25} length={12} />
